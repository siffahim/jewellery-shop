...
const Navigation = () => {
    ...
    const handleContact = () => {
        swal({ title: `Thank you ${user.displayName}`, text: "Please look at our website footer.Here you got communication details with us!", icon: "info" })
    }
    return (
        <Navbar bg="light" className='px-2' variant="light" collapseOnSelect expand="lg">
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="ms-auto">
                    ...
                    <Nav.Link as={Link} to="/jewellery">Shop</Nav.Link>
